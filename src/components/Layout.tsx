                ...
                <div className="app-root" ref={containerRef} style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div className="top-bar" style={{ height: topBarHeight, display: 'flex', alignItems: 'stretch' }}>
                                ...
                                <div className="bar-center" style={{ flex: 1, padding: 12 }}>
                                        <div style={{ background: 'white', borderRadius: 8, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#374151' }}>
                                                Map / Flow area
                                        </div>
                                </div>
                        </div>
                        ...
                        <div className="MapPlusWorkflowArea" style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative' }}>
                                ...
                                <div className="Poppable-1" style={{ flex: 1, position: 'relative', overflow: 'hidden', paddingBottom: bottomBarHeight }}>
                                        ...
                                        {showSideMenu && (
                                                <div className="side-popup-overlay" onClick={() => setShowSideMenu(false)}>
                                                        <div className="side-popup" onClick={(e) => e.stopPropagation()}>
                                                                <SideMenu toggleWorkflow={() => setShowWorkflow((s) => !s)} close={() => setShowSideMenu(false)} />
                                                        </div>
                                                </div>
                                        )}
                                </div>
